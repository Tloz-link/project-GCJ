...
public class UI_Joystick : UI_Popup
{
    ...
    public virtual void OnPressed()
    {
        ...
        Vector2 offset = position - (Vector2)donut.position;
        ...
        circle.position = (Vector2)donut.position + offset; // 터치 위치로 조이스틱 손잡이를 이동시킨다.

        // 플레이어 컨트롤러에 방향을 전달한다.
        Managers.Game.SetInputDirection(offset.normalized);
    }
